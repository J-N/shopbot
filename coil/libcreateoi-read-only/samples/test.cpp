...
int main()
{
	constructMap();
	 ...
	 item* myItem = new item(22,nodes[0]->connections[1], 800);
	nodes[0]->connections[1]->items.push_back(myItem);
	std::cout<<*myItem<<std::endl;
	
	myItem = new item(36,nodes[0]->connections[1], 1300);
	nodes[0]->connections[1]->items.push_back(myItem);
	std::cout<<*myItem<<std::endl;

	myItem = new item(44,nodes[1]->connections[0], 800);
	nodes[1]->connections[0]->items.push_back(myItem);
	std::cout<<*myItem<<std::endl;
	
	myItem = new item(55,nodes[1]->connections[0], 2200);
	nodes[1]->connections[0]->items.push_back(myItem);
	std::cout<<*myItem<<std::endl;
	
	myItem = new item(66,nodes[1]->connections[1], 400);
